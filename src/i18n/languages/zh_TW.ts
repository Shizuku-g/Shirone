...
export const zh_TW: Translation = {
	...
	[Key.musicExpandPlayer]: "展開音樂播放器",
	[Key.musicCollapsePlayer]: "收起音樂播放器",
	[Key.musicShowLyrics]: "顯示歌詞",
	[Key.musicHideLyrics]: "顯示封面",
	[Key.musicNoLyrics]: "暫無歌詞",
	[Key.musicNotPlaying]: "未在播放",
	[Key.musicWaitingPlaylist]: "等待歌單載入",
	[Key.musicSeek]: "跳轉播放進度",
	[Key.musicDragPlayer]: "拖動音樂播放器",
