...
export const th: Translation = {
	...
	[Key.musicExpandPlayer]: "ขยายเครื่องเล่นเพลง",
	[Key.musicCollapsePlayer]: "ย่อเครื่องเล่นเพลง",
	[Key.musicShowLyrics]: "แสดงเนื้อเพลง",
	[Key.musicHideLyrics]: "แสดงปก",
	[Key.musicNoLyrics]: "ไม่มีเนื้อเพลง",
	[Key.musicNotPlaying]: "ไม่ได้เล่น",
	[Key.musicWaitingPlaylist]: "กำลังโหลดเพลย์ลิสต์",
	[Key.musicSeek]: "ไปยังตำแหน่งเล่น",
	[Key.musicDragPlayer]: "ลากเครื่องเล่นเพลง",
