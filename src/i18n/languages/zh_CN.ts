...
export const zh_CN: Translation = {
	...
	[Key.musicExpandPlayer]: "展开音乐播放器",
	[Key.musicCollapsePlayer]: "收起音乐播放器",
	[Key.musicShowLyrics]: "显示歌词",
	[Key.musicHideLyrics]: "显示封面",
	[Key.musicNoLyrics]: "暂无歌词",
	[Key.musicNotPlaying]: "未在播放",
	[Key.musicWaitingPlaylist]: "等待歌单加载",
	[Key.musicSeek]: "跳转播放进度",
	[Key.musicDragPlayer]: "拖动音乐播放器",
